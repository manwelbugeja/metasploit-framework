...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/lang/String;Ljava/util/ArrayList;Landroid/os/Bundle;IILandroid/app/Notification;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;I)V
    ...
    iput-object v1, v0, Landroid/support/v4/app/y;->a:Landroid/app/Notification$Builder;

    new-instance v1, Landroid/os/Bundle;

    invoke-direct {v1}, Landroid/os/Bundle;-><init>()V

    iput-object v1, v0, Landroid/support/v4/app/y;->b:Landroid/os/Bundle;
    ...
    iget-object v3, v0, Landroid/support/v4/app/y;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v2, v0, Landroid/support/v4/app/y;->c:Landroid/widget/RemoteViews;

    move-object/from16 v1, p29

    iput-object v1, v0, Landroid/support/v4/app/y;->d:Landroid/widget/RemoteViews;

    move-object/from16 v1, p30

    iput-object v1, v0, Landroid/support/v4/app/y;->e:Landroid/widget/RemoteViews;

    move/from16 v1, p31

    iput v1, v0, Landroid/support/v4/app/y;->f:I
...
.method public a()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/y;->b:Landroid/os/Bundle;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/app/y;->e:Landroid/widget/RemoteViews;
    ...
    :cond_2
    iget v1, p0, Landroid/support/v4/app/y;->f:I
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/y;->d(Landroid/app/Notification;)V
...
.method public b(Landroid/support/v4/app/b0;)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/app/x;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/b0;)V
