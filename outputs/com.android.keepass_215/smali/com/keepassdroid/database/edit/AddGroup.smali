...
.method private constructor <init>(Landroid/content/Context;Lcom/keepassdroid/Database;Ljava/lang/String;ILcom/keepassdroid/database/PwGroup;Lcom/keepassdroid/database/edit/OnFinish;Z)V
    ...
    .line 53
    new-instance p1, Lcom/keepassdroid/database/edit/AddGroup$AfterAdd;

    iget-object p2, p0, Lcom/keepassdroid/database/edit/AddGroup;->mFinish:Lcom/keepassdroid/database/edit/OnFinish;

    invoke-direct {p1, p0, p2}, Lcom/keepassdroid/database/edit/AddGroup$AfterAdd;-><init>(Lcom/keepassdroid/database/edit/AddGroup;Lcom/keepassdroid/database/edit/OnFinish;)V

    iput-object p1, p0, Lcom/keepassdroid/database/edit/AddGroup;->mFinish:Lcom/keepassdroid/database/edit/OnFinish;
...
.method static synthetic access$000(Lcom/keepassdroid/database/edit/AddGroup;)Lcom/keepassdroid/database/PwGroup;
    ...
    .line 28
    iget-object p0, p0, Lcom/keepassdroid/database/edit/AddGroup;->mParent:Lcom/keepassdroid/database/PwGroup;
...
.method static synthetic access$100(Lcom/keepassdroid/database/edit/AddGroup;)Lcom/keepassdroid/database/PwGroup;
    ...
    .line 28
    iget-object p0, p0, Lcom/keepassdroid/database/edit/AddGroup;->mGroup:Lcom/keepassdroid/database/PwGroup;
...
.method public static getInstance(Landroid/content/Context;Lcom/keepassdroid/Database;Ljava/lang/String;ILcom/keepassdroid/database/PwGroup;Lcom/keepassdroid/database/edit/OnFinish;Z)Lcom/keepassdroid/database/edit/AddGroup;
    ...
    .line 39
    new-instance v8, Lcom/keepassdroid/database/edit/AddGroup;
...
.method public run()V
    ...
    .line 58
    iget-object v0, p0, Lcom/keepassdroid/database/edit/AddGroup;->mDb:Lcom/keepassdroid/Database;
    ...
    iput-object v1, p0, Lcom/keepassdroid/database/edit/AddGroup;->mGroup:Lcom/keepassdroid/database/PwGroup;

    .line 62
    iget-object v2, p0, Lcom/keepassdroid/database/edit/AddGroup;->mName:Ljava/lang/String;

    invoke-virtual {v0}, Lcom/keepassdroid/database/PwDatabase;->newGroupId()Lcom/keepassdroid/database/PwGroupId;

    move-result-object v3

    invoke-virtual {v1, v2, v3}, Lcom/keepassdroid/database/PwGroup;->initNewGroup(Ljava/lang/String;Lcom/keepassdroid/database/PwGroupId;)V

    .line 63
    iget-object v1, p0, Lcom/keepassdroid/database/edit/AddGroup;->mGroup:Lcom/keepassdroid/database/PwGroup;
    ...
    iget-object v2, v2, Lcom/keepassdroid/database/PwDatabase;->iconFactory:Lcom/keepassdroid/database/PwIconFactory;

    iget v3, p0, Lcom/keepassdroid/database/edit/AddGroup;->mIconID:I

    invoke-virtual {v2, v3}, Lcom/keepassdroid/database/PwIconFactory;->getIcon(I)Lcom/keepassdroid/database/PwIconStandard;

    move-result-object v2

    iput-object v2, v1, Lcom/keepassdroid/database/PwGroup;->icon:Lcom/keepassdroid/database/PwIconStandard;

    .line 64
    iget-object v1, p0, Lcom/keepassdroid/database/edit/AddGroup;->mGroup:Lcom/keepassdroid/database/PwGroup;

    iget-object v2, p0, Lcom/keepassdroid/database/edit/AddGroup;->mParent:Lcom/keepassdroid/database/PwGroup;

    invoke-virtual {v0, v1, v2}, Lcom/keepassdroid/database/PwDatabase;->addGroupTo(Lcom/keepassdroid/database/PwGroup;Lcom/keepassdroid/database/PwGroup;)V

    .line 69
    new-instance v0, Lcom/keepassdroid/database/edit/SaveDB;

    iget-object v1, p0, Lcom/keepassdroid/database/edit/AddGroup;->ctx:Landroid/content/Context;

    iget-object v2, p0, Lcom/keepassdroid/database/edit/AddGroup;->mDb:Lcom/keepassdroid/Database;

    iget-object v3, p0, Lcom/keepassdroid/database/edit/AddGroup;->mFinish:Lcom/keepassdroid/database/edit/OnFinish;

    iget-boolean v4, p0, Lcom/keepassdroid/database/edit/AddGroup;->mDontSave:Z
